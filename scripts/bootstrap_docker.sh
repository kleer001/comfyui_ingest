#!/bin/bash
# VFX Pipeline Bootstrap Script - Docker Edition
# Downloads and runs the Docker installation wizard
#
# Usage (Linux or WSL2):
#   curl -fsSL https://raw.githubusercontent.com/kleer001/comfyui_ingest/main/scripts/bootstrap_docker.sh | bash
#   or
#   wget -qO- https://raw.githubusercontent.com/kleer001/comfyui_ingest/main/scripts/bootstrap_docker.sh | bash
...
print_header "VFX Pipeline - Docker Automated Installer"
...
print_header "Launching Docker Installation Wizard"
...
echo "  2. Run pipeline: bash scripts/run_docker.sh --name MyProject /workspace/projects/video.mp4"

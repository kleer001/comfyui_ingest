...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/kleer001/shot-gopher/main/scripts/bootstrap_conda_test.sh | bash
#   or
#   wget -qO- https://raw.githubusercontent.com/kleer001/shot-gopher/main/scripts/bootstrap_conda_test.sh | bash
